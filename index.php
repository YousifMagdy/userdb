...
<html lang="en">
  ...
  <body background="bk/background.jpeg">    
    <div class="container">
...
<?php
  while ($user = $all_user->fetch_assoc()) { ?>
    <tr>
      ...
      <i onclick="confirm_delete(<?php echo $user['id']; ?>);" class="text-danger" data-feather="x-circle"></i>
      <i onclick="edit(<?php echo $user['id']; ?>);" class="text-success" data-feather="edit-2"></i>
      </div>
      </td>
      </tr>
<?php
